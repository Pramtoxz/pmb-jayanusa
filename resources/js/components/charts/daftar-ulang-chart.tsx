...
interface DaftarUlangChartProps {
  data: {
    labels: string[];
    data: number[];
  };
...
export function DaftarUlangChart({ data }: DaftarUlangChartProps) {
  ...
  const totalDaftarUlang = React.useMemo(() => {
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        ...
        <CardDescription>Status Daftar Ulang Terkini</CardDescription>
      </CardHeader>
                  ...
                  if (viewBox && "cx" in viewBox && "cy" in viewBox) {
                    return (
                      ...
                      >
                        ...
                        >
                          {totalDaftarUlang.toLocaleString()}
                        </tspan>
                        <tspan
                          x={viewBox.cx}
                          y={(viewBox.cy || 0) + 24}
