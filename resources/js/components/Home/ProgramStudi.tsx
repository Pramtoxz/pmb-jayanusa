export default function ProgramStudi() {
    return (
        <section id="program-studi" className="py-16 bg-gradient-to-br from-white via-[#FFF2F2] to-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
                        <div className="mb-6">
                            <div className="w-16 h-16 bg-[#FFF2F2] rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#02188B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                            </div>
                            <h3 className="text-2xl font-bold text-[#02188B] mb-4">
                                D3 - Manajemen Informatika
                            </h3>
                            <h4 className="text-1xl font-bold text-[#FF4433] mb-4">
                                Akreditasi B
                            </h4>
                            <p className="text-[#706f6c] mb-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center text-[#02188B]">
