...
export default function ProgramKerjasama() {
    ...
    return (
        <section className="py-16 bg-gradient-to-br from-white via-[#FFF2F2] to-white dark:from-[#161615] dark:via-[#1D0002] dark:to-[#161615] overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="carousel-container mx-auto max-w-full">
                                    ...
                                    <div className="flex gap-4 sm:gap-6 md:gap-8">
                                        ...
                                        {[
                                            ...
                                            <div key={index} className="carousel-item">
                                                <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-white dark:bg-[#161615] rounded-full flex items-center justify-center p-2 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-[#FFD700]">
                                                    <img 
                                                        src={partner.img} 
                                                        alt={partner.name} 
                                                ...
                                                <h3 className="mt-2 md:mt-4 text-sm sm:text-base md:text-lg font-semibold text-[#02188B] dark:text-[#FF4433] text-center">
                                                    {partner.name}
                                                </h3>
                                            </div>
                                        ))}
                                ...
                                <div className="flex justify-center mt-4 gap-2 md:hidden">
                                    <div className="w-8 h-1 bg-[#02188B] dark:bg-[#FF4433] rounded-full opacity-50"></div>
                                    <div className="w-8 h-1 bg-[#02188B] dark:bg-[#FF4433] rounded-full"></div>
                                    <div className="w-8 h-1 bg-[#02188B] dark:bg-[#FF4433] rounded-full opacity-50"></div>
                                </div>
                            </div>
                        </div>
