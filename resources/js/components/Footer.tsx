        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-4 mb-6">
              ...
              />
              <h3 className="text-lg font-semibold text-[#02188B] dark:text-[#FF4433]">Tentang Kami</h3>
            </div>
            <p className="text-sm text-[#706f6c] dark:text-[#A1A09A] leading-relaxed mb-6">
              STMIK (Sekolah Tinggi Manajemen Informatika dan Komputer) Jayanusa berdiri pada tahun 2002 berdasarkan SK DIKTI No. 153/D/O/2002 tanggal 02 Agustus 2002. Dan Alhamdulillah sampai saat ini semua Prodi yang ada sudah Ter-Akreditasi B.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-[#706f6c] dark:text-[#A1A09A]">
              ...
              <div className="flex items-center">
                ...
                <span>(0751)-28984 atau HP : 08116650635</span>
              </div>
            </div>
          </div>
        </div>
