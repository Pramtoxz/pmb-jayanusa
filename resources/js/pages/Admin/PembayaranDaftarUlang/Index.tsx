...
export default function Index({ pembayarans }: { pembayarans: PembayaranDaftarUlang[] }) {
    const [sorting, setSorting] = React.useState<SortingState>([])
    const [columnFilters, setColumnFilters] = React.useState<ColumnFiltersState>([])

    const columns: ColumnDef<PembayaranDaftarUlang>[] = [
        {
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="shadow-md border-gray-200 dark:border-gray-700">
                            ...
                            <DropdownMenuItem 
                                onSelect={(e) => {
                                    e.preventDefault();
                                    router.get(`/admin/pembayaran-daftar-ulang/${payment.id}`);
                                }}
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Konfirmasi Pembayaran Daftar Ulang" />
            <Toaster />
            <div className="flex h-full flex-1 flex-col space-y-8 p-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-2xl font-bold tracking-tight">Konfirmasi Pembayaran Daftar Ulang</h2>
                        <p className="text-muted-foreground">
                            Kelola dan konfirmasi pembayaran daftar ulang mahasiswa baru
                        </p>
                    </div>
